...
//  StringToInt => int
// ---------------
[UnityEditor.CustomPropertyDrawer(typeof(StringToIntDictionary))]
public class StringToIntDictionaryDrawer : SerializableDictionaryDrawer<string, int> {
    protected override SerializableKeyValueTemplate<string, int> GetTemplate() {
        return GetGenericTemplate<SerializableStringToIntTemplate>();
    }
}
internal class SerializableStringToIntTemplate : SerializableKeyValueTemplate<string, int> { }